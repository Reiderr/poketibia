...
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE,"Congratulations you found a ["..getItemNameById(card_id[w]).."].")
doRemoveItem(item.uid, 1)
doSendMagicEffect(getThingPosWithDebug(cid), 27)
else
